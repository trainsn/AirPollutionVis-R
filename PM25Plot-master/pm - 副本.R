...
if(!file.exists("E:/Rstudy/PM25Plot-master/pm.RData"))
{
  ...
  load("E:/Rstudy/PM25Plot-master/pm.RData")
}


if(!file.exists("E:/Rstudy/PM25Plot-master/pm.CityCorrelate.RData"))
{
  pm = pm[pm$type=="PM2.5",]
  ...
  load("E:/Rstudy/PM25Plot-master/pm.CityCorrelate.RData")
}
